...
export default async function HomeImagePart(): Promise<Component> {
    ...
    const title = t("title");
    return (
        <section className="items-center flex flex-col mt-10 min-h-[77vh]">
            ...
            <h1
                className={cn(
                    AppTextStyle.h1,
                    "text-center tablet:text-6xl text-4xl mt-5",
                )}
            >
                {title}
            </h1>
            <h2
                className={cn(
                    ...
                    "text-center mt-3 tablet:text-2xl text-xl",
                )}
            >
                {t("description1")} <b>{t("description2")}</b>{" "}
                {t("description3")} <b>{t("description4")}</b>{" "}
                {t("description5")}
            </h2>
        </section>
    );
