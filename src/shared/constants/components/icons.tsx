...
const KIcons = {
    ...
    // activeLike: (props: IconProps): Component => <Plus {...props} className={cn(baseClass,  props?.className)} />,
    // smile: (props: IconProps): Component => <Info {...props} className={cn(baseClass, props?.className)} />,
    // activeSmile: (props: IconProps): Component => <Info {...props} className={cn(baseClass,  props?.className)} />,
    // dislike: (props: IconProps): Component => <Minus {...props} className={cn(baseClass, props?.className)} />,
    // activeDislike: (props: IconProps): Component => <Minus {...props} className={cn(baseClass,  props?.className)} />,
