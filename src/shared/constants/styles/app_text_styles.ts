export default abstract class AppTextStyle {
    ...
    // Material Theme Display Styles
    static readonly displayLarge: string = 'text-[3.5625rem] font-normal leading-tight tracking-tight'; // 57px = 3.5625rem
    static readonly displayMedium: string = 'text-[2.8125rem] font-normal leading-snug'; // 45px = 2.8125rem
    static readonly displaySmall: string = 'text-4xl font-normal leading-normal'; // 36px = 2.25rem

    // Material Theme Headline Styles
    static readonly headlineLarge: string = 'text-[2rem] font-medium leading-tight'; // 32px = 2rem
    static readonly headlineLargeBold: string = 'text-[2rem] font-bold leading-tight'; // 32px = 2rem
    static readonly headlineMedium: string = 'text-[1.75rem] font-medium leading-snug'; // 28px = 1.75rem
    static readonly headlineMediumBold: string = 'text-[1.75rem] font-bold leading-snug'; // 28px = 1.75rem
    ...
    static readonly labelSmall: string = 'text-[0.6875rem] font-medium leading-normal tracking-tight'; // 11px = 0.6875rem

    // Material Theme Title Styles
    static readonly titleLarge: string = 'text-[1.375rem] font-normal leading-normal'; // 22px = 1.375rem
    static readonly titleLargeBold: string = 'text-[1.375rem] font-bold leading-normal'; // 22px = 1.375rem
    ...
    // Heading Styles
    static readonly h1: string = 'text-[4rem] font-medium leading-none tracking-tight'; // 64px = 4rem
