export default abstract class KTextConstants {
    ...
    static readonly ownerUrl = "https://portfolio.demien-Ilnytskyi.workers.dev";
    ...
    static readonly ownerGitHub = "https://github.com/DemienIlnytskyi";
    ...
    static readonly baseUrl =
        KTextConstants.isDev
            ...
            : KTextConstants.isDevENV
                ? "https://portfolio-development.demien-Ilnytskyi.workers.dev"
                : "https://portfolio.demien-Ilnytskyi.workers.dev";
