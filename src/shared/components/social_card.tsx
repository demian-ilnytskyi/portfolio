...
export default function SocilaCard({
    ...
    return <li >
        <a className={cn(
            ...
            "flex flex-wrap px-5 py-2 rounded-3xl gap-x-5 gap-y-2",
            ...
            <div className="flex flex-col">
                ...
                <div className="h-0.5 w-full from-gray-400 to-gay-600 bg-linear-to-t my-1" />
                <p className={cn(
                    AppTextStyle.bodyMedium,
                    'dark:text-gray-300 text-gray-500 line-clamp-1 overflow-ellipsis'
                )}>
                    {description}
                </p>
            </div>
