// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 9c19a35cbaee1d19e0ab3975a1be55a8)
// Runtime types generated with workerd@1.20250321.0 2024-12-30 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		_discount_key_: KVNamespace;
		_discounts_list_key_: KVNamespace;
		_discounts_suggestions_key_: KVNamespace;
		ASSETS: Fetcher;
	}
}
