/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ad84c1b510a8893f6fc8c409833f9692)
// Runtime types generated with workerd@1.20260825.1 2025-06-13 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	VINEXT_KV_CACHE: KVNamespace;
	ERRORS_DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	ERRORS_PAGE_PASSWORD: string;
	WORKER_SELF_REFERENCE: Fetcher /* portfolio-development */ | Fetcher /* portfolio */;
}
declare namespace Cloudflare {
	interface DevelopmentEnv {
		...
		ASSETS: Fetcher;
		ERRORS_PAGE_PASSWORD: string;
		WORKER_SELF_REFERENCE: Fetcher /* portfolio-development */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ERRORS_PAGE_PASSWORD">> {}
}
